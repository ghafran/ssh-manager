...
@property (assign) IBOutlet NSWindow *ssh_window;
@property (assign) IBOutlet NSTextField *ssh_host_field;
@property (assign) IBOutlet NSTextField *ssh_port_field;
@property (assign) IBOutlet NSTextField *ssh_key_field;
@property (assign) IBOutlet NSWindow *ssh_add_folder;
@property (assign) IBOutlet NSTextField *ssh_user_field;
@property (assign) IBOutlet NSButton *ssh_connection_button;
@property (assign) IBOutlet NSButton *save_button;
@property (assign) IBOutlet NSTextField *ssh_folder;
